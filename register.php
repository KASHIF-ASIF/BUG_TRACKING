...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO User (username, email, password, user_role) VALUES ('$username', '$email', '$hashed_password', '$user_role')";
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <div class="card-text"><b style="color: crimson;">Create</b> your account here...</div>
                    <div class="card-body">
                        <form action="" method="post">
                            <input required type="text" minlength="3" placeholder="Enter Username..." name="username" style="width: 100%;"><br><br>
                            ...
                            <input required type="password" onkeypress="return RestrictCommaSemicolon(event);" ondrop="return false;" onpaste="return false;" minlength="8" name="password" id="myInput" placeholder="Enter Password..." style="width: 100%;"><br>
